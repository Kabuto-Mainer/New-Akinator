...
XXX GK_VIEW_MAIN_TEXT               = 3;
XXX GK_CHOICE_MAIN_TEXT             = 4;
XXX GK_EXIT_MAIN_TEXT               = 5;

XXX GK_INIT_MAIN_IMG                = 6;
XXX GK_START_PLAY_MAIN_IMG          = 7;
XXX GK_VIEW_MAIN_IMG                = 8;
XXX GK_CHOICE_MAIN_IMG              = 9;
XXX GK_EXIT_MAIN_IMG                = 10;
